//
//  ServicePointPackagesTableViewController.swift
//  Postman
//
...
class ServicePointPackagesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        postmanApi.getRequestsAtServicePoint(id: location!.id, completionHandler: success)
    ...
    func success(err: Error?, requests: [Request]?, response: URLResponse?) -> Void {
